...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <div class="subtitle">Add New Student</div>
                </div>
                <div class="col-md-4 text-end">
                    <i class="fas fa-user-plus" style="font-size: 50px; opacity: 0.3;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="nav-bar">
        <div class="container">
            ...
            <a href="#" class="active"><i class="fas fa-user-plus"></i> Add Student</a>
        </div>
    </div>
    ...
    <div class="container-custom">
        <div class="form-card">
            ...
            <p class="subtitle">Fill in the details below to add a new student to the system.</p>
